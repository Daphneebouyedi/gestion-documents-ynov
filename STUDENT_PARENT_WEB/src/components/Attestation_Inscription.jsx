...
const AttestationInscription = () => {
  ...
  const generatePdf = () => {
    ...
    doc.text("ATTESTATION D'INSCRIPTION", pageWidth - margin, yPos + 10, { align: 'right' });
    yPos += 30;
    ...
    doc.setFontSize(11);
    doc.text(`Cette attestation confirme que M/Mme ${formData.nom} ${formData.prenom} est inscrit(e) à l'établissement pour l'année scolaire ${formData.anneeScolaire}.`, margin, yPos, {
